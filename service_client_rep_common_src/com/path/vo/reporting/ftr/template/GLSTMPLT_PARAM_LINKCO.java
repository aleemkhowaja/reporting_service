...
public class GLSTMPLT_PARAM_LINKCO extends BaseVO 
{
    private GLSTMPLT_PARAM_LINKVO glstmpltParamLinkVO = new GLSTMPLT_PARAM_LINKVO();
    ...
    public void setCODE3_NAME(String cODE3NAME)
    {
        CODE3_NAME = cODE3NAME;
    }
    ...
    public GLSTMPLT_PARAM_LINKVO getGlstmpltParamLinkVO()
    {
	return glstmpltParamLinkVO;
    }

    public void setGlstmpltParamLinkVO(GLSTMPLT_PARAM_LINKVO glstmpltParamLinkVO)
    {
	this.glstmpltParamLinkVO = glstmpltParamLinkVO;
    }
